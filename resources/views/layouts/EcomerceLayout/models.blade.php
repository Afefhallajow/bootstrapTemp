						...
						<div class="action-header clearfix">
							<div class="float-left hidden-xs d-flex ml-2">
								<div class="img_cont mr-3">
									<img src="{{URL::asset('EcomerceAsset/img/faces/6.jpg')}}" class="rounded-circle user_img" alt="img">
								</div>
						...
						<div class="card-body msg_card_body">
							...
							<div class="d-flex justify-content-start">
								<div class="img_cont_msg">
									<img src="{{URL::asset('EcomerceAsset/img/faces/6.jpg')}}" class="rounded-circle user_img_msg" alt="img">
								</div>
							...
							<div class="d-flex justify-content-end ">
								...
								<div class="img_cont_msg">
									<img src="{{URL::asset('EcomerceAsset/img/faces/9.jpg')}}" class="rounded-circle user_img_msg" alt="img">
								</div>
							</div>
							<div class="d-flex justify-content-start ">
								<div class="img_cont_msg">
